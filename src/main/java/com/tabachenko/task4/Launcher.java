...
public class Launcher {
    public static void main(String[] args) {
        ...
        taskManager.add(LocalDate.parse("1945-09-01"), new Task("AlexLearn12", "School"));
        taskManager.add(LocalDate.parse("1925-09-01"), new Task("AlexLearn3", "School"));
        ...
        String [] categoris = {"School","workingNow","univercity","PARASHA"};
